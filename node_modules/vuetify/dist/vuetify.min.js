...
if(null!==l)if(t.preventDefault(),"track"===e.navigationStrategy){const e=B(l);-1!==e&&(C.value=e)}else F(l)}function $(e){I.value=!0}function F(e){if(_.value)return ae(_.value,e)}return Bt(()=>{const a=N.value?l.ariaMultiselectable??!String(e.selectStrategy).startsWith("single-"):void 0
return t.createVNode(e.tag,{ref:_,class:t.normalizeClass(["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav,"v-list--slim":e.slim},i.value,s.value,c.value,d.value,p.value,w.value,m.value,e.class]),style:t.normalizeStyle([{"--v-list-indent":b(e.indent),"--v-list-prepend-gap":b(e.prependGap)},u.value,v.value,e.style]),tabindex:e.disabled?-1:0,role:N.value?"listbox":"list","aria-activedescendant":"track"===e.navigationStrategy&&C.value>=0?`v-list-item-${E}-${C.value}`:void 0,"aria-multiselectable":a,onFocusin:P,onFocusout:A,onFocus:R,onBlur:T,onKeydown:D,onMousedown:$},{default:()=>[t.createVNode(Pr,{items:r.value,returnObject:e.returnObject},n)]})}),{open:g,select:y,focus:F,children:f,parents:h,getPath:V,navigationIndex:C}}}),jr=kt("v-list-img"),Hr=vt({start:Boolean,end:Boolean,...pt(),...Pa()},"VListItemAction"),Wr=wt()({name:"VListItemAction",props:Hr(),setup(e,a){let{slots:l}=a
